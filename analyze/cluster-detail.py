...
df_1000 = pd.read_csv("cluster/data/2018-01-31_10-06/result_candidate.csv")
...
gen_graph({"シミュレーション時間 50": df_50, "シミュレーション時間 100": df_100, "シミュレーション時間 250": df_250, "シミュレーション時間 500": df_500, "シミュレーション時間 1000": df_1000}, "cluster")
...
df_1000 = df_1000.sort_values(by="time_avg").reset_index(drop=True)[:50]
gen_graph({"シミュレーション時間 50": df_50, "シミュレーション時間 100": df_100, "シミュレーション時間 250": df_250, "シミュレーション時間 500": df_500, "シミュレーション時間 1000": df_1000}, "cluster-top50")
